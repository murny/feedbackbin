...
class User::NamedTest < ActiveSupport::TestCase
  ...
  test "familar name" do
    assert_familiar_name "Michael", "Michael"
    assert_familiar_name "Salvador Dali", "Salvador Dali"
    assert_familiar_name "Lin-Manuel Miranda", "Lin-Manuel Miranda"
    assert_familiar_name "Anne Christine García", "Anne Christine García"
    assert_familiar_name "Ángela López", "Ángela López"
  end
