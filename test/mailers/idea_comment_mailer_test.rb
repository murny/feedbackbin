...
class IdeaCommentMailerTest < ActionMailer::TestCase
  ...
  test "new_comment HTML body includes a GET unwatch link with a signed token" do
  ...
  test "new_comment text body includes a bare unsubscribe URL with a non-empty token" do
