...
puts "Creating posts for FeedbackBin tenant..."
...
ApplicationRecord.with_tenant("feedbackbin") do
  ...
  Post.suppressing_turbo_broadcasts do
    ...
    Post.find_or_create_by!(
      ...
      post.body = "As a product user, I need better insights into our feedback data. It would be amazing to have:\n\n- "\
...
puts "✅ Seeded posts for FeedbackBin tenant"