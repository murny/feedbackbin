...
ApplicationRecord.with_tenant(techcorp_org.subdomain) do
  dashboard_post = Post.find_by!(title: "Dashboard performance improvements")
...
# InnovateLabs comments
ApplicationRecord.with_tenant(innovatelabs_org.subdomain) do
  android_notifications_post = Post.find_by!(title: "Push notifications not working on Android")
  figma_integration_post = Post.find_by!(title: "Figma integration for design handoffs")
