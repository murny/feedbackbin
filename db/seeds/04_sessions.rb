...
shane = Identity.find_by!(email_address: "shane.murnaghan@feedbackbin.com")

# Create some active sessions for the shane

# Mobile phone session
Session.find_or_create_by!(identity: shane, ip_address: "192.168.1.100") do |session|
...
Session.find_or_create_by!(identity: shane, ip_address: "192.168.1.101") do |session|
...
Session.find_or_create_by!(identity: shane, ip_address: "192.168.1.102") do |session|
