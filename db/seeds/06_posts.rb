...
feedbackbin_customer_feedback = Category.find_by!(name: "Customer Feedback", organization: feedbackbin_org)
feedbackbin_bug_reports = Category.find_by!(name: "Bug Reports", organization: feedbackbin_org)
feedbackbin_feature_requests = Category.find_by!(name: "Feature Requests", organization: feedbackbin_org)
feedbackbin_ui_ux = Category.find_by!(name: "UI/UX Feedback", organization: feedbackbin_org)

techcorp_product = Category.find_by!(name: "Product", organization: techcorp_org)
techcorp_engineering = Category.find_by!(name: "Engineering", organization: techcorp_org)

innovatelabs_mobile = Category.find_by!(name: "Mobile App", organization: innovatelabs_org)
innovatelabs_platform = Category.find_by!(name: "Platform", organization: innovatelabs_org)
innovatelabs_integrations = Category.find_by!(name: "Integrations", organization: innovatelabs_org)
...
Post.suppressing_turbo_broadcasts do
  # FeedbackBin posts
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_customer_feedback, author: admin_user, title: "Could you please add dark mode") do |post|
    post.body = "I would love to see dark mode on this site, please give support for it"
    post.created_at = 13.days.ago
  end

  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_customer_feedback, author: admin_user, title: "Multiple categories") do |post|
    post.body = "I would like to be able to create multiple categories, is this possible?"
    post.created_at = 9.days.ago
  end

  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_feature_requests, author: maya_user, title: "Mobile app support") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_feature_requests, author: alex_user, title: "Slack integration for notifications") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_bug_reports, author: carlos_user, title: "Search functionality not working with special characters") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_ui_ux, author: david_user, title: "Accessibility improvements needed") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_feature_requests, author: sarah_user, title: "Advanced analytics dashboard") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_feature_requests, author: jane_user, title: "Better collaboration features") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_ui_ux, author: maya_user, title: "More customization options for brands") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_bug_reports, author: carlos_user, title: "Page load times are slow with large datasets") do |post|
  ...
  Post.find_or_create_by!(organization: feedbackbin_org, category: feedbackbin_feature_requests, author: alex_user, title: "Public API for integrations") do |post|
  ...
  # TechCorp posts
  Post.find_or_create_by!(organization: techcorp_org, category: techcorp_product, author: alex_user, title: "Dashboard performance improvements") do |post|
  ...
  Post.find_or_create_by!(organization: techcorp_org, category: techcorp_engineering, author: carlos_user, title: "API rate limiting issues") do |post|
  ...
  Post.find_or_create_by!(organization: techcorp_org, category: techcorp_product, author: maya_user, title: "User onboarding flow feedback") do |post|
  ...
  # InnovateLabs posts
  Post.find_or_create_by!(organization: innovatelabs_org, category: innovatelabs_mobile, author: admin_user, title: "Push notifications not working on Android") do |post|
  ...
  Post.find_or_create_by!(organization: innovatelabs_org, category: innovatelabs_platform, author: maya_user, title: "Real-time collaboration features") do |post|
  ...
  Post.find_or_create_by!(organization: innovatelabs_org, category: innovatelabs_integrations, author: fake_user, title: "Figma integration for design handoffs") do |post|
  ...
  Post.find_or_create_by!(organization: innovatelabs_org, category: innovatelabs_platform, author: alex_user, title: "Improved search with filters") do |post|
  ...
  Post.find_or_create_by!(organization: innovatelabs_org, category: innovatelabs_mobile, author: fake_user, title: "Dark mode inconsistencies in mobile app") do |post|
