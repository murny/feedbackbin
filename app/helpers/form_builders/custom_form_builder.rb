...
module FormBuilders
  class CustomFormBuilder < ActionView::Helpers::FormBuilder
    ...
    SUBMIT_CLASSES = "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium " \
    ...
    def text_area(attribute, options = {})
      # Special textarea classes with field-sizing-content and min-h-16
    ...
    def text_layout(attribute)
      @template.content_tag :div, class: "grid gap-2", "data-slot": "form-item" do
